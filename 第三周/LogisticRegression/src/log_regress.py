...
Author:KingTreeS
2018-10-14
Use logistic regression to predict rating of movies
"""
import xlrd
import numpy as np
...
def ratingTest():
    # 读取文件，处理数据
    filename = '/Volumes/D/软微课程作业/数据分析工具实践/第三周/1801220013-束超哲-第三次作业/LogisticRegression/data/2014 and 2015 CSM dataset.xlsx'
